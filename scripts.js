...
// Giriş Tarihi (Check-In) Seçici
$('#res_date').daterangepicker({
    singleDatePicker: true,
    showDropdowns: true,
    autoUpdateInput: true, // Tarih otomatik yazılır
...
$('#res_date').on('apply.daterangepicker', function (ev, picker) {
    ...
    $(this).val(selectedDate); // Giriş tarihini alana yaz

    // Çıkış tarihini temizle ve yeniden başlat
    const minCheckoutDate = moment(selectedDate).add(1, 'days').format('YYYY-MM-DD');
    $('#res_date1').val(''); // Çıkış tarihini sıfırla

    $('#res_date1').daterangepicker({
        singleDatePicker: true,
        showDropdowns: true,
        autoUpdateInput: true, // Tarih otomatik yazılır
        parentEl: $(".date-container1"),
...
$('#res_date').on('cancel.daterangepicker', function () {
    $(this).val(''); // Giriş tarihini temizle
    $('#res_date1').val(''); // Çıkış tarihini de temizle
});

// Çıkış Tarihi (Check-Out) Seçici
$('#res_date1').daterangepicker({
    singleDatePicker: true,
    showDropdowns: true,
    autoUpdateInput: true, // Tarih otomatik yazılır
...
$('#res_date1').on('apply.daterangepicker', function (ev, picker) {
    const selectedDate = picker.startDate.format('YYYY-MM-DD');
    $(this).val(selectedDate); // Çıkış tarihini alana yaz
});

$('#res_date1').on('cancel.daterangepicker', function () {
    $(this).val(''); // Çıkış tarihini temizle
});
